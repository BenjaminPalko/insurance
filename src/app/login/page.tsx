    ...
    return (
        <main className={'flex flex-col items-center justify-center gap-10'}>
            ...
            <form className={'flex flex-col gap-5 w-full max-w-sm'} onSubmit={onSubmit}>
                <div>
                    <label htmlFor="UserEmail" className="block text-xs font-medium text-gray-200">
                        Email
                    </label>
                    ...
                    <input
                        ...
                        type="email"
                        id="UserEmail"
                        className="mt-1 h-10 w-full px-2 rounded-md border border-gray-200 bg-gray-600 outline-gray-200 focus:border-blue-600 focus:outline-none shadow-sm sm:text-sm"
                    />
                    <span
                ...
                <div>
                    <label htmlFor="Password" className="block text-xs font-medium text-gray-200">
                        Password
                    </label>
                ...
                <button type={'submit'} onClick={onSubmit} className={'bg-primary-main rounded p-2'}>Submit</button>
